...
/* harmony import */ var _multiplayer_gateway_multiplayer_gateway_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./multiplayer-gateway/multiplayer-gateway.component */ "./src/app/multiplayer-gateway/multiplayer-gateway.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _multiplayer_gateway_multiplayer_gateway_component__WEBPACK_IMPORTED_MODULE_8__["MultiplayerGatewayComponent"]
            ],
            imports: [
...
module.exports = "#playerBoard, #opponentBoard{\n    width: 40%;\n    display: inline-block;\n    margin-left: 3%;\n    vertical-align: top;\n    text-align: center;\n    padding-top: 10px;\n}\n\n#playerBoard{\n    margin-left: 3%;\n    margin-right: 3%;\n}\n\n.cell{\n    display: inline-block;\n    vertical-align: top;\n    height: 35px;\n    margin: 1px;\n    border-radius: 3px;\n    width: 35px;\n    background-color: rgba(0,0,0,1);\n}\n\n.uncovered{\n    background-color: gray;\n}\n\n.test{\n    background-color: red;\n}\n\n.mine {\n    height: 30px;\n    width: 30px;\n    margin-top: 2px;\n}\n\n#refresh{\n    margin-bottom: 0%;\n    width: 40px;\n    margin-left: 31.8%;\n    height: 40px;\n}\n\n.dropdown {\n    font-size: 23px;\n    margin-left: 0%;\n    text-decoration: none;\n    color: #f0a554;\n    margin-top: 15%;\n    display: inline-block;\n}\n\n.dropdown a {\n    display: block;\n    cursor: pointer;\n}\n\n.shareLink img {\n    height: 40px; \n    width: 40px;\n}\n\n.shareLink {\n    margin-left: 29%;\n    margin-top: 38%;\n}\n\n#options ul {\n    list-style-type: none;\n    padding: 0;\n    text-align: center;\n}\n\n#options {\n    text-align: center;\n    position: absolute;\n    box-shadow: 0px 0px 177px 61px black;\n    top: 21%;\n    padding: 60px;\n    border-radius: 8px;\n    left: 42%;\n    border: 1px solid gray;\n    background-color: rgba(47, 79, 79, 0.9);\n}\n\nli {\n    margin-bottom: 34%;\n    text-align: center;\n    font-size: 22px;\n}\n\nli a{\n    text-decoration: none;\n    color: white;\n    font-family: monospace;\n    cursor: pointer;\n}\n\n#cancel{\n    margin-top: 40%;\n    font-size: 19px;\n    background-image: linear-gradient(blue, #5b5bff);\n    box-shadow: 0px 3px 18px 3px black;\n    padding: 12px;\n    border: 1px solid black;\n    border-radius: 5px;\n    cursor: pointer;\n    color: white;\n    outline: none;\n}\n\n.hidden {\n    display: none;\n}\n\n.dropdownDisplayed {\n    margin-bottom: 0%;\n}\n\n.selectedDifficulty {\n    color: #619600 !important;\n}\n\n.flagging {\n    height: 5px;\n    width: 5px;\n    margin-top: 15px;\n}\n\n.flagged {\n    height: 25px;\n    width: 22px;\n    margin-left: 5px;\n    margin-top: 6px;\n}\n\n.cell p {\n    font-size: 22px;\n    margin-bottom: 2px;\n    margin-top: 6px;\n}\n\n.one{\n    color: rgb(0, 97, 0)\n}\n\n.two {\n    color: rgb(0, 0, 193)\n}\n\n.three {\n    color: rgb(103, 0, 0)\n}\n\n.four {\n    color: darkblue;\n}\n\n.five {\n    color: darkred;\n}\n\n.six {\n    color: darkslategray;\n}\n\n.seven {\n    color: black\n}\n\n.eight {\n    color: rgb(116, 31, 0);\n}\n\n#winner {\n    text-align: center;\n    position: absolute;\n    box-shadow: 0px 0px 177px 61px black;\n    top: 26%;\n    padding: 76px;\n    cursor: pointer;\n    border-radius: 8px;\n    left: 37%;\n    border: 1px solid gray;\n    background-color: rgba(47, 79, 79, 0.95);\n}\n\n#winner h2 {\n    color: #f0a554;\n}\n\n#winner h4 {\n    color: #f0a554;\n}\n\n#winner button {\n    font-size: 19px;\n    background-image: linear-gradient(blue, #5b5bff);\n    box-shadow: 0px 3px 18px 3px black;\n    padding: 12px;\n    border: 1px solid gray;\n    border-radius: 5px;\n    color: white;\n    outline: none;\n}\n\n.ticker {\n    display: inline-block;\n    vertical-align: top;\n}\n\n.name {\n    margin-left: 15%;\n}\n\n#timer h2 {\n    color: #619600;\n    border-radius: 5px;\n    padding: 8px;\n    background-image: linear-gradient(#000567, #000cea);\n    box-shadow: 6px 7px 15px black;\n    border: 1px solid black;\n}\n\n#timer h6 {\n    color: #f0a554;\n}\n\n#numMines h6 {\n    color: #f0a554;\n}\n\n#numMines{\n    font-family: monospace;\n    font-size: 19px;\n}\n\n#numMines h2 {\n    color: #619600;\n    box-shadow: 6px 7px 15px black;\n    border-radius: 5px;\n    padding: 8px;\n    background-image: linear-gradient(#000567, #000cea);\n    border: 1px solid black;\n}\n\n#timer{\n    margin-left: 13%;\n    font-family: monospace;\n    font-size: 19px;\n}\n\n.multiplayer {\n    margin-left: 45%;\n    margin-bottom: 0px;\n    color: #619600;\n    margin-top: 1%;\n}\n\n.playerName{\n    color : #f0a554;\n}\n\n.opponentName {\n    color: gray !important;\n}\n\n.opponentLabel {\n    color: black !important;\n    background-image: linear-gradient(gray, gray) !important;\n\n}\n\n.choice {\n    left: 31%;\n    top: 34%;\n    text-align: center;\n    position: absolute;\n    box-shadow: 0px 0px 177px 61px black;\n    padding: 89px;\n    border-radius: 8px;\n    border: 1px solid gray;\n    background-color: rgba(47, 79, 79, 0.9);\n}\n\n.choiceButton{\n    margin-right: 31px;\n    margin-left: 42px;\n    display: inline-block;\n    vertical-align: top;\n}\n\n.choiceButton button{\n    font-size: 19px;\n    background-image: linear-gradient(blue, #5b5bff);\n    box-shadow: 0px 3px 18px 3px black;\n    padding: 12px;\n    border: 1px solid black;\n    border-radius: 5px;\n    cursor: pointer;\n    color: white;\n    outline: none;\n}\n\n.choiceButton{\n    color: #619600;\n    font-size: 18px;\n}\n\n.choiceButton h5 {\n    position: absolute;\n}\n\n#publicH5 {\n    left : 48%;\n}\n\n@media only screen and (min-width : 1600px){\n    .multiplayer {\n        margin-left: 46% !important;\n    }\n\n    #options {\n        left: 44% !important;\n    }\n}\n\n#waitingForUser {\n    color: white;\n    font-size: 30px;\n    position: absolute;\n    left: 62.5%;\n    top: 50%;\n}\n\n#waitingForUser:after {\n    overflow: hidden;\n    display: inline-block;\n    vertical-align: bottom;\n    -webkit-animation: ellipsis steps(4,end) 1500ms infinite;\n    animation: ellipsis steps(4,end) 1500ms infinite;\n    content: \"\\2026\";\n    width: 0px;\n}\n\n@keyframes ellipsis {\n    to {\n        width: 1.25em;    \n    }\n}\n\n@-webkit-keyframes ellipsis {\n    to {\n        width: 1.25em;    \n    }\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MultiComponent = /** @class */ (function () {
    ...
    MultiComponent.prototype.private = function () {
        var _this = this;
        this.userChose = true;
    ...
    MultiComponent.prototype.public = function () {
        this.userChose = true;
    };
...
/***/ "./src/app/multiplayer-gateway/multiplayer-gateway.component.css":
/*!***********************************************************************!*\
  !*** ./src/app/multiplayer-gateway/multiplayer-gateway.component.css ***!
  \***********************************************************************/
/*! no static exports found */
...
module.exports = ".header {\n    margin-left: 37%;\n    color: #619600;\n}\n\n.choice {\n    margin-left: 22%;\n    display: inline-block;\n    vertical-align: top;\n    text-align: center;\n}\n\n.choice button {\n    margin-top: 40%;\n    font-size: 19px;\n    background-image: linear-gradient(blue, #5b5bff);\n    box-shadow: 0px 3px 18px 3px black;\n    padding: 12px;\n    border: 1px solid black;\n    border-radius: 5px;\n    cursor: pointer;\n    color: white;\n    outline: none;\n}\n\n.choice h5 {\n    color : #f0a554;\n}\n\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/multiplayer-gateway/multiplayer-gateway.component.html":
/*!************************************************************************!*\
  !*** ./src/app/multiplayer-gateway/multiplayer-gateway.component.html ***!
  \************************************************************************/
/*! no static exports found */
...
module.exports = "<h2 class = 'header'>Please Choose From One of These Options</h2>\n\n\n<div class = 'choice'>\n  <button (click) = 'navigate(\"private\")'>Private Game</button>\n  <h5>Invite a friend to play a competitive game of minesweeper with you</h5>\n</div>\n\n<div class = 'choice'>\n  <button (click) = 'navigate(\"public\")'>Public Game</button>\n  <h5>You are randomly assigned an opponent from among all active users</h5>\n</div>"

/***/ }),

/***/ "./src/app/multiplayer-gateway/multiplayer-gateway.component.ts":
/*!**********************************************************************!*\
  !*** ./src/app/multiplayer-gateway/multiplayer-gateway.component.ts ***!
  \**********************************************************************/
/*! exports provided: MultiplayerGatewayComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MultiplayerGatewayComponent", function() { return MultiplayerGatewayComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _app_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../app.component */ "./src/app/app.component.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
...
var MultiplayerGatewayComponent = /** @class */ (function () {
    function MultiplayerGatewayComponent(_component, _router) {
        this._component = _component;
        this._router = _router;
    }
    MultiplayerGatewayComponent.prototype.ngOnInit = function () {
        this._component.currentPage = 'gateway';
    };
    MultiplayerGatewayComponent.prototype.navigate = function (page) {
        this._router.navigate(['multi']);
    };
    MultiplayerGatewayComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-multiplayer-gateway',
            template: __webpack_require__(/*! ./multiplayer-gateway.component.html */ "./src/app/multiplayer-gateway/multiplayer-gateway.component.html"),
            styles: [__webpack_require__(/*! ./multiplayer-gateway.component.css */ "./src/app/multiplayer-gateway/multiplayer-gateway.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], MultiplayerGatewayComponent);
    return MultiplayerGatewayComponent;
}());
